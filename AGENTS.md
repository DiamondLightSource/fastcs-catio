...
**Setup requirements (already configured in this project):**
...
| Device hierarchy trees | ASCII art | Matches what users see in TwinCAT UI |
| Nested structures (PDOs, etc.) | ASCII art | Mermaid compresses deeply nested subgraphs |
...
- TwinCAT device tree views (nomenclature.md)
- Controller hierarchy trees showing parent-child nesting
- Any diagram where the tree structure IS the information

**Converting ASCII art trees to Mermaid:**
...
**Related files:**
- `docs/conf.py` - Sphinx configuration with mermaid settings
- `docs/_static/custom.css` - CSS overrides for diagram sizing
- `docs/explanations/architecture-overview.md` - Example of complex Mermaid diagrams
